(self["webpackChunkansible_dashboard"] = self["webpackChunkansible_dashboard"] || []).push([["vendors-node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime-d8a8e7"],{
...
function FormattedMessage(props) {
    ...
    if (Component) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0__.createElement.apply(/*#__PURE__*/ (react__WEBPACK_IMPORTED_MODULE_0___namespace_cache || (react__WEBPACK_IMPORTED_MODULE_0___namespace_cache = __webpack_require__.t(react__WEBPACK_IMPORTED_MODULE_0__, 2))), (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__spreadArray)([Component, null], nodes));
    }
    ...
    _createClass(Truncate, [{
        ...
        value: function getLines() {
            ...
            for (var line = 1; line <= numLines; line++) {
                ...
                if (line === numLines) {
                    ...
                    resultLine = react__WEBPACK_IMPORTED_MODULE_0__.createElement(
                        'span',
                        null,
                        lastLineText,
                        ellipsis
        ...
        value: function renderLine(line, i, arr) {
            if (i === arr.length - 1) {
                ...
                var br = react__WEBPACK_IMPORTED_MODULE_0__.createElement('br', { key: i + 'br' });
...
Truncate.propTypes = {
    ...
    ellipsis: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().node),
    lines: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOf([false]), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number)]),
    trimWhitespace: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool),
    width: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number),
    onTruncate: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func)
};
